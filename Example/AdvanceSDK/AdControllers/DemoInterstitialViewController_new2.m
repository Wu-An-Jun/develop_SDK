...
@interface DemoInterstitialViewController_new2 () <AdvanceInterstitialDelegate>
@property (nonatomic, strong) AdvanceInterstitial *advanceInterstitial;
@end

@implementation DemoInterstitialViewController_new2
...
//        @{@"addesc": @"mediaId-adspotId", @"adspotId": @"100255-10006501"},
        ...
        @{@"addesc": @"mm插屏-Bidding", @"adspotId": @"102768-10008520"},
        @{@"addesc": @"mm插屏-倍业", @"adspotId": @"102768-10007791"},
        @{@"addesc": @"mm插屏-穿山甲", @"adspotId": @"100008-10000034"},
        @{@"addesc": @"mm插屏-优量汇", @"adspotId": @"102768-10007810"},
        @{@"addesc": @"mm插屏-快手", @"adspotId": @"102768-10007818"},
        @{@"addesc": @"mm插屏-百度", @"adspotId": @"102768-10007836"},
        @{@"addesc": @"mm插屏-Tanx", @"adspotId": @"102768-10009460"},
        @{@"addesc": @"mm插屏-Sigmob", @"adspotId": @"102768-10011980"}
    ];
